...
class BaseEventLoopThread(threading.Thread):
...
class EventLoopThread(BaseEventLoopThread):
    def __init__(self):
        super().__init__(name="GlobalRunningLoop")
...
class AsyncSSHLoopThread(BaseEventLoopThread):
    def __init__(self):
        super().__init__(name="AsyncSSHLoop")
