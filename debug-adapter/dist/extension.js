...
`, logger_1.LogLevel.Error);
            try {
              await fs2.promises.mkdir(path2.dirname(options.logFilePath), { recursive: true });
...
// node_modules/timers-promises/index.js
var require_timers_promises = __commonJS({
  "node_modules/timers-promises/index.js"(exports, module2) {
    "use strict";
    ...
    function promisesSetTimeout(after, value, options = {}) {
      ...
      return oncancel !== void 0 ? ret.finally(() => signal.removeEventListener("abort", oncancel)) : ret;
    }
...
var DebugSession = class extends events.EventEmitter {
  ...
  parseDebbugerOutput(line) {
    if (line.match(/^\(gdb\)\s*/) || line === "") {
      if (!this._isStarted) {
        this._isStarted = true;
        const cmd2 = this.cmdQueue[0];
        console.log("taking out empty line:", cmd2);
        if (cmd2.text === "\n") {
          this.cmdQueue.shift();
  ...
  executeCommand(command, token, immediate, isNative) {
  ...
  environmentCd(path2) {
    var fullCmd = `environment-cd ${path2}`;
    return this.executeCommand(fullCmd, null);
  }
